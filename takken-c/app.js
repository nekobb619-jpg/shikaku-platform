  ...
  var DEVICE_RENDERERS = {
    ...
    rights: function(t){
      switch(t.visual){
        ...
        case 'key-pass':
          return '<div class="r-gate-bar unlocked"></div><div class="device-caption">鍵の受け取り（引渡し）だけで通行証が手に入る特例</div>';
        case 'backup-link':
          return '<div class="r-magnet-pair"><div></div><div></div></div><div class="device-caption">本体と常時直結、順番を問わず作動</div>';
        case 'missing-button':
          return '<div class="generic-dot" style="opacity:.3;"></div><div class="device-caption">ボタンが外されている＝先に本体を調べてとは言えない</div>';
        case 'console-tiers':
          return '<div class="r-magnet-pair"><div></div><div></div><div></div></div><div class="device-caption">単独・過半数・全員一致の3段階権限</div>';
        case 'split-meter':
          return '<div class="r-gate-bar unlocked" style="width:50%;"></div><div class="device-caption">相続人の組み合わせで配分比率が自動的に変わる</div>';
        default:
    ...
    gyoho: function(t){
      switch(t.visual){
        ...
        case 'stock-gate':
          return '<div class="g-lock-icon"></div><div class="device-caption">倉庫にない部品は出荷リストに載せられない</div>';
        case 'fee-meter':
          return '<div class="g-gauge-bar"><div class="g-gauge-fill" style="width:50%"></div></div><div class="device-caption">代金の目盛りで自動的に上限が切り替わる</div>';
        case 'sequence-gate':
          return '<div class="g-signal-set"><div class="g-signal-dot amber"></div><div class="g-signal-dot green"></div></div><div class="device-caption">検査票（前）→納品書（後）の固定順序</div>';
        case 'staffing-gauge':
          return '<div class="g-gauge-bar"><div class="g-gauge-fill" style="width:80%"></div></div><div class="device-caption">作業員5人につき主任検査官1人以上の配置基準</div>';
        default:
          return '<div class="generic-dot"></div><div class="device-caption">' + (t.core || '') + '</div>';
      }
    },
